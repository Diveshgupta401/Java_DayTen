...
public class constact {
	...
	public constact createconstact() {
		constact cs = new constact();
...
public class AddressBook extends constact {

	public ArrayList<constact> createAddressBook() {
		ArrayList<constact> arr = new ArrayList<constact>();
		return arr;
	}
	...
	public static void main(String[] args) {
		...
		Hashtable<String, ArrayList<constact>> ht = new Hashtable<String, ArrayList<constact>>();
