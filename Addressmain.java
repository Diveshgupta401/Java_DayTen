...
public class Addressmain {
	...
	public Addressmain createContact() {
		Addressmain cs = new Addressmain();
...
public class Addressmain extends Addressmain {

	public ArrayList<Addressmain> createAddressBook() {
		ArrayList<Addressmain> arr = new ArrayList<Addressmain>();
		return arr;
	}
